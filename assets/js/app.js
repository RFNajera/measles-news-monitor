...
async function init() {
  ...
  try {
    ...
    status.innerHTML = `
      ...
      <a href="https://www.cidrap.umn.edu/measles" target="_blank" rel="noopener noreferrer">CIDRAP measles news page.</a> I'm not affiliated with them, but they do good work.
    `;
