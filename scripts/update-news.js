...
const FEED_URL = "https://news.google.com/rss/search?q=measles&hl=en-US&gl=US&ceid=US:en";
...
async function fetchFeed() {
  const response = await fetch(FEED_URL, {
    headers: {
      "user-agent": "Mozilla/5.0 measles-news-monitor"
    }
  });
...
async function main() {
  ...
  console.log(`Saved ${payload.itemCount} items to data/news.json`);
}
